...
const Welcome = ({ Prev,
  ...
  return (
    ...
    <div className='md:flex items-center  md:w-full '>
      <div className='px-36 h-screen hidden md:flex items-center  justify-center bg-[rgb(244,244,255)] border-r-2 border-[#7976FF]'>
      ...
      <div className='w-full p-16 space-y-14 '>
        ...
        <div className='space-y-10'>
          ...
          <p className='text-gray-600 dark:text-slate-400 lg:pr-44'>Nous sommes ravis de t'accueillir dans notre communauté dynamique et diversifiée. Que tu sois ici pour partager tes passions, découvrir de nouvelles idées, ou simplement pour te connecter avec des personnes partageant les mêmes centres d'intérêt, tu es au bon endroit.</p>
        </div>
